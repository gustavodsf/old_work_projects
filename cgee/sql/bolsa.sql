...
CREATE TABLE pg_bolsa (
  id int(11) NOT NULL AUTO_INCREMENT,
  txt_titulo_processo_bolsa varchar(600),
  txt_titulo_processo_bolsa_tag varchar(800),
  dta_inicio date,
  dta_termino date,
...
ALTER TABLE  bolsa_origem ADD INDEX ob_id_original (id_original) USING BTREE;

CREATE TABLE bolsa_origem_has_palavra (
...
ALTER TABLE  bolsa_origem_has_palavra ADD INDEX ohpb_idpalavra(idpalavra) USING BTREE;
ALTER TABLE  bolsa_origem_has_palavra ADD INDEX ohpb_idorigem(idorigem) USING BTREE;

CREATE TABLE bolsa_radical (
...
ALTER TABLE  bolsa_palavras ADD INDEX bp_idstem(idstem) USING BTREE;
ALTER TABLE  bolsa_palavras ADD INDEX bp_tipo(tipo) USING BTREE;
ALTER TABLE  bolsa_palavras ADD UNIQUE unique_index(palavra,tipo);
