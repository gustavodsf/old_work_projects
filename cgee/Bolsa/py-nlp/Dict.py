...
class Dict:
	...
	def __init__(self,bolsaDAO,pool_sema,writeLogFile):
		self.wordDict = dict()
		self.stemDict = dict()
		self.usedWordId = dict()
		self.bolsaDAO = bolsaDAO
	...
	def addWordDict(self,word,idSource,generateID,typeWord):
		...
		self.bolsaDAO.savePalavraHasOrigem(idWordHasTxt,idSource,idWord)
	...
	def saveStemAndWordDict(self,cycle):
		...
		self.bolsaDAO.saveWordDict(self.wordDict)
		self.writeLogFile.writeOnFileHashWord(self.wordDict)
		print ("..:: Salvando os radicais ::..")
		self.bolsaDAO.saveStemDict(self.stemDict)
