...
class Dict:
	...
	def __init__(self,convenioDAO,semaStem,semaWord,writeLogFile):

		self.wordDict = dict()
		self.stemDict = dict()
		self.usedWordId = dict()
		self.convenioDAO = convenioDAO
	...
	def saveStemAndWordDict(self,cycle):
		...
		self.convenioDAO.saveWordDict(self.wordDict)
		self.writeLogFile.writeOnFileHashWord(self.wordDict)
		print ("..:: Salvando os radicais ::..")
		self.convenioDAO.saveStemDict(self.stemDict)
