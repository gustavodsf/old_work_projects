...
class Dict:
	...
	def __init__(self,producaoDAO,pool_sema,writeLogFile):
		self.wordDict = dict()
		self.stemDict = dict()
	...
	def addWordDict(self,word,idSource,generateID,typeWord):
		...
		self.producaoDAO.savePalavraHasOrigem(idWordHasTxt,idSource,idWord)
	...
	def saveStemAndWordDict(self,cycle):
		...
		self.producaoDAO.saveWordDict(self.wordDict)
		self.writeLogFile.writeOnFileHashWord(self.wordDict)
		print ("..:: Salvando os radicais ::..")
		self.producaoDAO.saveStemDict(self.stemDict)
