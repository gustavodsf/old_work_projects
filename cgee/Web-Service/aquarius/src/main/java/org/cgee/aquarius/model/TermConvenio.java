...
@Entity
@Table(name="convenio_palavras")
public class TermConvenio implements Serializable {
	...
	public StemConvenio getStem() {
		return stem;
	}

	public void setStem(StemConvenio stem) {
		this.stem = stem;
	}
