...
@Entity
@Table(name="producao_palavras")
public class TermProducao implements Serializable {
	...
	public StemProducao getStem() {
		return stem;
	}

	public void setStem(StemProducao stem) {
		this.stem = stem;
	}
