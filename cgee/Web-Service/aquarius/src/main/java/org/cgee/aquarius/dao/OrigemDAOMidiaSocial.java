...
@Repository
public class OrigemDAOMidiaSocial implements Serializable{
	...
	public List<Object> findOrigemByWords(String wordPrincipal,String word){
		String strQuery = "SELECT o.titulo FROM midia_social_palavras a INNER JOIN midia_social_origem_has_palavra b ON a.idpalavras = b.idpalavra INNER JOIN midia_social_origem_has_palavra d ON b.idorigem = d.idorigem "+
						  "INNER JOIN midia_social_palavras c ON d.idpalavra = c.idpalavras INNER JOIN midia_social_origem o ON o.idorigem = b.idorigem WHERE "+
