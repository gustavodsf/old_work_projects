...
@Repository
public class OrigemDAOBolsa implements Serializable{
	...
	public List<Object> findOrigemByWords(String wordPrincipal,String word){
		String strQuery = "SELECT o.titulo FROM bolsa_palavras a INNER JOIN bolsa_origem_has_palavra b ON a.idpalavras = b.idpalavra INNER JOIN bolsa_origem_has_palavra d ON b.idorigem = d.idorigem "+
						  "INNER JOIN bolsa_palavras c ON d.idpalavra = c.idpalavras INNER JOIN bolsa_origem o ON o.idorigem = b.idorigem WHERE "+
