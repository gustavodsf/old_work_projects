...
@Repository
public class OrigemDAODespesas implements Serializable{
	...
	public List<Object> findOrigemByWords(String wordPrincipal,String word){
		String strQuery = "SELECT o.titulo FROM dispendios_palavras a INNER JOIN dispendios_origem_has_palavra b ON a.idpalavras = b.idpalavra INNER JOIN dispendios_origem_has_palavra d ON b.idorigem = d.idorigem "+
						  "INNER JOIN dispendios_palavras c ON d.idpalavra = c.idpalavras INNER JOIN dispendios_origem o ON o.idorigem = b.idorigem WHERE "+
