...
@Repository
public class OrigemDAOProducao implements Serializable{
	...
	public List<Object> findOrigemByWords(String wordPrincipal,String word){
		String strQuery = "SELECT o.titulo FROM producao_palavras a INNER JOIN producao_origem_has_palavra b ON a.idpalavras = b.idpalavra INNER JOIN producao_origem_has_palavra d ON b.idorigem = d.idorigem "+
						  "INNER JOIN producao_palavras c ON d.idpalavra = c.idpalavras INNER JOIN producao_origem o ON o.idorigem = b.idorigem WHERE "+
