...
@Entity
@Table(name="bolsa_palavras")
public class TermBolsa implements Serializable {
	...
	public StemBolsa getStem() {
		return stem;
	}

	public void setStem(StemBolsa stem) {
		this.stem = stem;
	}
