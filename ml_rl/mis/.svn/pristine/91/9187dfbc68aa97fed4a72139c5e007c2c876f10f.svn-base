...
public class Objeto implements Serializable{
	...
	@SequenceGenerator(name="OBJETO_SEQUENCE_GENERATOR", sequenceName="OBJETO_SEQUENCE", initialValue=1, allocationSize=1)
	
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="OBJETO_SEQUENCE_GENERATOR")
	private Long id;
